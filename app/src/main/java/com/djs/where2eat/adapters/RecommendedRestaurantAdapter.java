 ...
 */
public class RecommendedRestaurantAdapter extends RecyclerView.Adapter<RecommendedRestaurantAdapter.ViewHolder>{

    private List<RecommendedRestaurant> restaurants;
    private Context context;

    public RecommendedRestaurantAdapter(List<RecommendedRestaurant> restaurants, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final RecommendedRestaurant restaurant = restaurants.get(position);
